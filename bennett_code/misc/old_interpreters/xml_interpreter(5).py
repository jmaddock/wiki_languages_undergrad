...
def split_into_comments (subheading):
     ...
     comment_begin=0
     for comment in newline_iterator:
     ...
     author=re.search(ALL,subheading[comment_begin:])
     if author:
          comments_list.append(subheading[comment_begin:])
          authors_list.append(subheading[comment_begin+author.start():comment_begin+author.end()])
     if comments_list==list():
          comments_list.append('no signed comments')
          authors_list.append('no signed comments')
