data_directory = '/Users/Bennett/OneDrive/Northwestern/Research/Wiki_Project/data'
...
for (file in file_list) {
  ...
  new_mean_sub_length = median(file_data$subheading_line)
  ...
  mean_sub_length = append(mean_sub_length,new_mean_sub_length)
}

df=data.frame(file=lang,size,unsigned_sub,mean_depth,median_sub_length)
